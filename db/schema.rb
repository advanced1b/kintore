...
ActiveRecord::Schema.define(version: 20160711132656) do
  ...
  add_index "training_menus", ["menu_id"], name: "index_training_menus_on_menu_id", using: :btree
  add_index "training_menus", ["training_id"], name: "index_training_menus_on_training_id", using: :btree
